...
The purchase of the shopping centre and LCC is part of a legal manoeuvre [^2] that will overide the rights of those whose light will be effected by the redevelopment of the two sites. A leasing arrangement will allow both sites to return to Delancey and UAL control.    
...
[^1]: According to Southwark, Delancey is not strictly speaking the developer, but rather the advisor to the so-called 'Triangle Partnership', which is the Dutch pension fund APG, QDHK Holdngs Ltd Parnership, and Door SLP. There are further partnerships within this Triangle, detailed in the report para 12.  We will continue to refer to Delancey as the developer, being the active, publicly visible party. 
