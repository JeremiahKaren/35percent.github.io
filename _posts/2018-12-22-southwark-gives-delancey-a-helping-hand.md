...
Southwark's letter does not entertain the notion that the Castle Square application might be rejected, but rather says that  _'as and when planning permission is granted for Castle Square'_ , the shopping centre S106 agreement will be concluded.  In [a response on this point](https://docdro.id/t6AVbTv) to [campaigner's objection](https://docdro.id/OAz3IlX) to their letter,  Southwark says that the phrase 'as and when' 'acknowledged the fact that permission might not be granted', an interpretation that is not easy to agree with, in the abscence of an 'if' in the phrase.
