...
categories: 
---
{% img center http://35percent.org/images/viabilityspd.png 200 300 %}Southwark Council has bowed to developers' will and restricted public access to financial viability appraisals of planning applications. Instead of being published when planning applications are submitted, the appraisals will be published just one week before the planning committee takes its decision. The changes were made following pressure from developers, who have long been using these appraisals to reduce the amount of affordable housing they have to build.
...
{% img http://35percent.org/images/LLpara1.png %}
...
{% img http://35percent.org/images/keyassumptions.png %} 
