...
The Scheme falls short of these requirements in that it will be serviced by its own permananent CHP plant, which will have the 'potential' to be connected to the proposed energy centre on Thurlow St, but won't be serviced by it. This is acknoledged in the planning committee report for the FDS application, which says:
...
The 20% minimum on-site renewable energy requirement is not just a requirement of the AAAP, it is also a requirement of the AA's Core Strategy and SP? and the London Plan.
