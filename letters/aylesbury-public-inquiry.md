...
Policy BH6([II] - USE OF RENEWABLE ENERGY TECHNOLOGIES) further requires the CHP plant to be fuelled by a minimum 20% __on-site__ renewable energy sources:
...
Paragraph 6.3.3 of the the AAAP's Sustainability Assessment goes further to explain that:

>"New developments will also need to reduce carbon emissions by 20% using carbon renewable technologies. Currently, the most feasible way of doing this would appear to be by providing biomass CHP in the energy centre. Care needs to be taken however that any biomass plant complies with air quality legislation and targets, particularly as the site lies in an air quality management area (AQMA)."

However, the Scheme falls short of these requirements in that the development on the order land will be serviced by its own separate individual CHP plant, which will have the 'potential' to be connected to the proposed energy centre on Thurlow St, but won't be serviced by it. This is acknowledged in the planning committee report for the FDS application, which says:
...
Furthermore, both CHP plants will now be fuelled by mains gas - they will no longer be biomass plants fuelled by renewable energy sources. This is confirmed in the planning application's Revised Energy Strategy which says:
...
In summary, biomass is no longer considered suitable because the development on the order land is being powered by its own individual energy plant and not one centralised plant as required by the AAAP.

The planning committee report for the application acknowledges that the Scheme _"falls far short"_ of complying with the 20% minimum on-site renewable energy requirement:
...
Policy 3.6.7 of the AAAP goes further to say _"The government has announced the intention of ensuring that all homes are CfSH Level 6 by 2016. Proposals will need to comply with these regulations where these are more stringent than CfSH Level 4."_ 
...
This is a breach of the planning consent; the [planning committee report](http://planbuild.southwark.gov.uk/documents/?GetDocument=%7b%7b%7b!EBAeY2lWKnBCMyOrbAnyPA%3d%3d!%7d%7d%7d) for the development says that it will be fuelled by a central biomass CHP:
