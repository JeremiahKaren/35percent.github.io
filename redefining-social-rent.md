...
The [list](http://35percent.org/img/section106_tenure_breaches.pdf) is by no means exhaustive and we are calling for a borough-wide audit in order to establish the full scale of the problem. We submitted it to the Council as part of our [corporate complaint](http://crappistmartin.github.io/images/SN_affordablerent.pdf) in December 2015 and are yet to receive a substantive response.
