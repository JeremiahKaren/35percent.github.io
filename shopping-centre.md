...
Furthermore, shortly before the planning application was due to be heard, Delancey applied for an fall-back option to be able to build a hybrid BTR/BTS (Buy-to-Sell) scheme, for which it submitted a [separate viability assessment](http://planbuild.southwark.gov.uk/documents/?GetDocument=%7b%7b%7b!08IPAajx1d%2flXs093xrSJA%3d%3d!%7d%7d%7d). A confused paragraph in an addendum report appears to say that this is less viable than The planning committee allowed this, thus approving a scheme without sure knowledge of what tenure nearly half the housing will be. .
